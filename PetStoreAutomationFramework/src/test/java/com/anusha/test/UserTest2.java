...
public class UserTest2 {
	...
	Response res=UserEndPoint2.getUser(userPayload.getUsername());
	...
	Response res=UserEndPoint2.updateUser(userPayload,userPayload.getUsername());
	...
	Response resAfterPut=UserEndPoint2.getUser(userPayload.getUsername());
	...
	Response res=UserEndPoint2.deleteUser(userPayload.getUsername());
